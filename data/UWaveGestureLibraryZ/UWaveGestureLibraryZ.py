...
def create_data(df, memory_size_):
    name_init = 'UWaveGestureLibraryZ_init_mem' + str(memory_size_) + '.csv'
...
if __name__ == '__main__':
    dfTrain = pd.read_csv('UWaveGestureLibraryZ_Train.csv')
    dfTest = pd.read_csv('UWaveGestureLibraryZ_TEST.csv')
    ...
    name_arr = 'UWaveGestureLibraryZ_arr_mem' + str(memory_size) + '.csv'
